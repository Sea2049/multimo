        ...
        <div class="card-content">
          ...
          <div v-if="simulationId" class="info-card">
            ...
            <div class="info-row">
              ...
              <span class="info-value mono">{{ currentSimulationId }}</span>
            </div>
            <div class="info-row">
          ...
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                ...
                <span class="section-desc">Multimo 自动规划推演现实 <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> 小时，每轮代表现实 <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> 分钟时间流逝</span>
              </div>
...
const handleStartSimulation = () => {
  ...
  if (props.simulationMode === 'auto') {
    ...
    addLog(`Auto-Pilot: Starting simulation with ${params.maxRounds} rounds`)
...
onMounted(() => {
  // 自动开始准备流程
  // 即使没有 simulationId，也要开始，因为我们会自动创建
